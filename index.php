...
<body>
    ...
    <form action="backend.php" method="get">
        ...
        Latitude: <input type="text" name="request_data[latitude]" required><br>
        Longitude: <input type="text" name="request_data[longitude]" required><br>
    ...
    <form action="backend.php" method="get">
        ...
        Address: <input type="text" name="request_data[address]" required><br>
